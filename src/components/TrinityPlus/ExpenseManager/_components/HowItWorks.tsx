  ...
  const rules = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: Zap,
        description:
          "Priorities shift? Trinity instantly recalculates everything like a financial Tetris master.",
        example:
          "Emergency AC repair? Trinity reshuffles all expenses to accommodate it immediately.",
        color: "yellow",
      ...
      },
      {
        ...
        icon: Shield,
        description:
          "Run multiple subscriptions while always maintaining emergency cash reserves.",
        example:
          "Trinity ensures you never drop below survival money, canceling lowest-priority subscriptions if needed.",
        color: "indigo",
      ...
      },
      {
        ...
        icon: Activity,
        description:
          "Every financial decision ripples through your entire cash flow - Trinity tracks it all.",
        example:
          "Pay off a loan? More daily capacity. Take a penalty? Temporarily reduced flow. All automatic.",
        color: "pink",
      ...
      <div className="container mx-auto px-6 relative ">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="text-slate-900">The 7 Smart Rules That</span>
