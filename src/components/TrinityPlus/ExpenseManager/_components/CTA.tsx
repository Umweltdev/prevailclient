      ...
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl p-12 text-center">
          ...
          >
            ...
            <button
              onClick={() => navigate("/trinity/plus#wizard")}
              className="px-8 py-4 bg-white/20 backdrop-blur text-white rounded-lg font-semibold text-lg border border-white/30 hover:bg-white/30 transition-all duration-300"
            >
              Schedule Demo
            </button>
          </div>
