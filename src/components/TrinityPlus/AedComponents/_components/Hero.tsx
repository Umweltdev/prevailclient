    ...
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto ">
        <div className="text-center">
          {/* Badge */}
          <div
            className={`inline-flex items-center px-6 py-3 bg-white/70 backdrop-blur-lg text-blue-700 rounded-full text-sm font-medium mb-8 border border-white/30 shadow-lg transition-all duration-1000 hover:shadow-xl hover:scale-105 ${
              isLoaded
          ...
          {/* Main Headline */}
          <h1
            className={`text-5xl md:text-7xl font-bold text-gray-900 mb-8 transition-all duration-1000 delay-200 ${
          ...
          >
            ...
            <span className="relative">
              ...
              <div
                className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-full transform scale-x-0 animate-pulse"
          ...
          {/* CTA Buttons */}
          <div
            className={`flex flex-col sm:flex-row items-center justify-center gap-6 mb-16 transition-all duration-1000 delay-600 ${
              isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <button onClick={()=> navigate('/trinity/plus#wizard')} className="group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full text-lg font-semibold overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105">
