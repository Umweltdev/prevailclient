...
const ScenarioCard: React.FC<Scenario> = ({ title, scenario, icon }) => {
  ...
  const getActorIcon = (actor: string) => {
    return actor.toLowerCase().includes("user") ||
    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-6">
        <div className="flex items-center">
          <div
            className={`p-3 rounded-xl bg-gradient-to-br from-blue-100 to-purple-100 transition-all duration-300 group-hover:from-blue-200 group-hover:to-purple-200 group-hover:scale-110 mr-4 ${
              isHovered ? "shadow-lg" : ""
            }`}
          >
      ...
      <div className="space-y-4 relative">
        {scenario.map((step: any, i: any) => (
          ...
          >
            {/* Step Indicator */}
            <div
              className={`flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 mr-4 ${
                currentStep === i
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                <div
                  className={`flex items-center ${getActorColor(
                    step.actor
                  )} mr-2`}
                >
              ...
              <div
                className={`relative bg-gray-50 rounded-lg p-3 transition-all duration-300 group-hover/step:bg-white group-hover/step:shadow-md ${
                  currentStep === i
      ...
      {isPlaying && (
        <div
          className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-b-2xl transition-all duration-300"
          style={{
