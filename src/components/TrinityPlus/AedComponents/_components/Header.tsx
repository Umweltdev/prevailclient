  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center group cursor-pointer">
              <div className="relative">
                ...
                />
                <div className="absolute inset-0 w-8 h-8 bg-blue-500/20 rounded-full scale-0 group-hover:scale-150 transition-transform duration-300 -"></div>
              </div>
              <span
                className={`ml-2 text-xl font-bold transition-all duration-300 ${
                  scrollY > 50
                    ? "text-gray-900"
            ...
            <nav className="hidden md:flex space-x-1">
              {["How It Works", "Features", "Results", "Pricing"].map(
                (item, index) => (
                  <a
                    key={item}
                    href={
            ...
            <div className="flex items-center space-x-3">
              <button
                className={`hidden md:block px-5 py-2 rounded-full font-medium transition-all duration-300 relative overflow-hidden group ${
                  scrollY > 50
      ...
      >
        ...
        <div
          className={`absolute top-16 left-4 right-4 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 transition-all duration-500 ${
            isMenuOpen
