...
const StatCard: React.FC<Stat> = ({ value, label, icon, delay }) => {
  ...
  return (
    <div
      className={`relative group bg-white/60 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl transition-all duration-700 hover:shadow-2xl hover:shadow-blue-500/10 hover:scale-105 hover:bg-white/70 ${
