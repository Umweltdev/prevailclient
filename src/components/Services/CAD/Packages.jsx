...
const handleCheckout = useCallback(async () => {
    ...
    try {
      // Extract numeric value from price string (e.g., "€350" -> 350)
      const priceValue = tierSelection.price.replace(/[^\d]/g, '');
