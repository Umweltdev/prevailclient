...
const DigitalAccelerator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Unlock Your Digital Potential with Prevail's Digital Accelerator
          Bundle
        </title>
        <meta
          name="description"
            ...
            >
              ...
              >
                ...
                <Typography>
                  ...
                  online presence is synchronised and powerful. This approach
                  saves you time and resources and provides you with a
                  competitive edge that is critical in today’s digital age.
                </Typography>
              </Stack>
            </Box>
          </Container>
          ...
          <Container maxWidth="lg">
            ...
            >
                ...
                <Stack spacing={4} py={8}>
                  ...
                  >
                    <Typography
                      ...
                      fontSize={"18px"}
                    >
                      Take advantage of the opportunity to transform your
                      business!
                    </Typography>
                  </Box>
                  ...
                  >
                    Save up to 70% on Prevail's Digital Accelerator Bundle now
                    and focus on what matters most
                  </Typography>

                  <Typography color={"#DCCCFC"}>
                    Increasing your visibility, enhancing your brand identity,
                    and building a robust online presence that drives success.
                    Act now—your digital transformation awaits! 
                  </Typography>
                  <Button
                    variant="contained"
                    sx={{
              ...
              <Grid item xs={12} md={5} sx={{ paddingTop: "0 !important" }}>
                ...
                >
                  <img
                    src="https://res.cloudinary.com/dtzuqacg3/image/upload/v1720419595/DAB-Promotion_qlwxnb.webp"
                    alt="DAB-Promotion"
                    style={{
                      width: "100%",
                      // height: "100%",
