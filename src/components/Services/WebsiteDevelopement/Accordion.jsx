...
const advantages = [
  ...
  },
  {
    ...
    text: "Say goodbye to frustrating 404 errors by redirecting the users to a different page, providing a seamless user journey.",
  },
  {
...
export default function AccordionUsage() {
  return (
    <Grid
      sx={{
        width: "40vw",
        "@media (max-width: 600px)": { width: "95vw", margin: "2vh auto" },
      }}
    >
