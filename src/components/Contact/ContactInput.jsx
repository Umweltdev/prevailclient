    ...
    width: "80%", "@media (max-width: 600px)": { width: "95vw", flexDirection: "column", }, }} >
     ...
     sx={{ 
      ...
      alignItems="center" flexWrap="wrap" >
        ...
        <TextField sx={{ width: "350px", "@media (max-width: 600px)": { width: "90vw", }, }} 
        ...
        <TextField id="outlined-multiline-static" label="How can we help you" multiline rows={4} // defaultValue="Default Value" 
        sx={{ width: "730px", mt: "2vh", "@media (max-width: 600px)": { width: "90vw", }, }} fullWidth /> 
        <CustomizedHook /> 
