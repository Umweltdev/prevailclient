      ...
      <Container maxWidth="lg" sx={{ padding: '3rem' }}>
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7.5}>
            <Typography variant="h1" component="h1" sx={{ fontSize: '5rem', lineHeight: 1.2, marginBottom: '1.5rem' }}>
              Your Partner in <br />
              Accelerating the <br />
          ...
          <Grid item xs={12} md={4.5}>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', width: '280px' }}>
              {[face1, face2, face3, face4, face5, face6, face7].map((face, index) => (
                <Box
                  key={index}
                  sx={{//👩🏻‍💻
                    width: (index === 0) ? "170px" : (index === 1) ? "110px" : (index === 2) ? "125px" : (index === 3) ? "155px" 
                    : (index === 4) ? "110px" : (index === 5) ? "85px" : (index === 6) ? "85px" : '140px',
                    height: '110px',
                    borderRadius: (index === 0 || index === 2 || index === 3) ? '25px' : 
                                 (index === 5 || index === 6) ? '50% / 25%' : '50%', // Vertical ellipse for face6 and face7
                    overflow: 'hidden',
                    display: 'flex',
                    justifyContent: 'center',
                    alignItems: 'center',
